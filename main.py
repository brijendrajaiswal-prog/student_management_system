...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # Create a status Bar and add Status
...
class AboutDialog(QMessageBox):
    def __init__(self):
        ...
        content = """
            This app was created by Brijendra Jaiswal
            Feel Free to use any time and modify as per your project.
        """
...
class DeleteDialog(QDialog):
    ...
    def delete_student(self):
        # Edit - Get Selected ROW and StudentID
...
class EditDialog(QDialog):
    def __init__(self):
        ...
        # Edit - Get Student-Name from selected ROW
        index = main_window.table.currentRow()
        student_name = main_window.table.item(index,1).text()

        # Edit - Get Student ID from selected Row
        self.student_id = main_window.table.item(index,0).text()
